      ...
      <div className="mx-auto max-w-7xl px-4 pb-8 pt-16 sm:pt-24 lg:pt-32">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-gray-300">
              Get relevant job opportunities in your inbox every week
            </p>
          </div>
          <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
            ...
            <div className="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
              <button
                type="submit"
                className="flex w-full items-center justify-center rounded-md bg-slate-400 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-slate-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; {new Date().getFullYear()} ManagerTrack, Inc. All rights
            reserved.
          </p>
        </div>
      </div>
