...
export default function Hero() {
  ...
  return (
    <>
      ...
      <main className="bg-[#F5EFFC]">
        <div className="relative isolate overflow-hidden">
          <svg
            className="absolute inset-x-0 -top-64 -z-10 h-[64rem] w-full stroke-gray-200 [mask-image:radial-gradient(32rem_32rem_at_center,white,transparent)]"
            aria-hidden="true"
          >
            <defs>
              <pattern
          ...
          <div
            className="absolute left-1/2 right-0 -top-64 -z-10 -ml-24 transform-gpu overflow-hidden blur-3xl lg:ml-24 xl:ml-48"
            aria-hidden="true"
          >
            <div
              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className="text-4xl font-medium tracking-tight text-gray-900 sm:text-5xl">
                    Create a Powerful Resume to Elevate Your Profile
                  </h1>
